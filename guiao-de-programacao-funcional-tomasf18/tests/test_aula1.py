...
#Exercicio 2.3
@mock.patch('aula1.par_elem_cont', side_effect = aula1.par_elem_cont)
def test_par_elem_cont(mock_par_elem_cont):
    assert mock_par_elem_cont([1,6,2,5,5,2,5,2]) == [(1, 1), (6, 1), (2, 3), (5, 3)]  
...
#Exercicio 3.5
@mock.patch('aula1.menor_lista', side_effect = aula1.menor_lista)
def test_menor_lista(mock_menor_lista):
    assert mock_menor_lista([1,2,3,0,5]) == (0, [1, 2, 3, 5])
...
#Exercicio 3.7
@mock.patch('aula1.dois_menores', side_effect = aula1.dois_menores)
def test_dois_menores(mock_dois_menores):
    assert mock_dois_menores([5,4,3,1,6]) == (1, 3, [5, 4, 6])
    
#Exercicio 3.8
@mock.patch('aula1.media_mediana', side_effect = aula1.media_mediana)
def test_media_mediana(mock_media_mediana):
    
    # Teste com lista ordenada com quantidade ímpar de elementos
    lista_impar = [1, 2, 3, 4, 5]
    assert mock_media_mediana(lista_impar) == (3.0, 3)
    
    # Teste com lista ordenada com quantidade par de elementos
    lista_par = [1, 2, 3, 4]
    assert mock_media_mediana(lista_par) == (2.5, 2.5)
    
    # Teste com lista de um único elemento
    lista_unica = [10]
    assert mock_media_mediana(lista_unica) == (10, 10)

    # Teste com lista vazia
    lista_vazia = []
    assert mock_media_mediana(lista_vazia) == (None, None)
    
    # Teste com números decimais
    lista_decimais = [1.5, 2.5, 3.5, 4.5]
    assert mock_media_mediana(lista_decimais) == (3.0, 3.0)
    
    # Teste com lista que contém números repetidos
    lista_repetidos = [2, 2, 2, 2, 2]
    assert mock_media_mediana(lista_repetidos) == (2.0, 2)
