...
#Exercicio 4.7
def test_quantificador_existencial():
    assert quantificador_existencial([11,12,9,14], lambda n: n < 10) == True
    assert quantificador_existencial([11,12,11,14], lambda n: n < 10) == False
...
def test_dois_menores_ordem():
    lista = [10, 3, 7, 2, 8]
    f = lambda x, y: x < y
    assert dois_menores_ordem(lista, f) == (2, 3, [10, 7, 8])
